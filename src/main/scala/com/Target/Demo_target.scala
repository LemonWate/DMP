...
object Demo_target {
  def main(args: Array[String]): Unit = {
    ...
    //测试数据
    //    sQLContext.sql("select imei,mac,idfa,openudid,androidid,imeimd5,macmd5,idfamd5,openudidmd5,androididmd5,imeisha1,macsha1,idfasha1,openudidsha1,androididsha1 from t where idfa=\"\" ").show()
